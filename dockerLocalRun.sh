...
docker run -d -p 127.0.0.1:7878:7878/tcp --name digital_clinic_catalog_service -i -t 405836331329.dkr.ecr.ap-southeast-1.amazonaws.com/digital-clinic-catalog:stage-1.0-SNAPSHOT-1713322583234 sh;
